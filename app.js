...
//Create a form data object
 ...
 submitData.append('MovieName', $('#FMovieName').val());
 ...
 submitData.append('Movie', $("#UpMovie")[0].files[0]);
...
,function getMovies(){
 ...
 $('#MovieList').html('<div class="spinner-border" role="status"><span class="sr-only"> &nbsp;</span>');
 ...
 items.push( "<hr />");
 items.push("<movie src='"+BLOB_ACCOUNT + val["filePath"] +"' width='400'/> <br />")
